...
public class Seat3 extends javax.swing.JFrame {
    ...
    private void initComponents() {
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                    ...
                    .addGroup(layout.createSequentialGroup()
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                            .addComponent(c3)
                            .addComponent(seatok, javax.swing.GroupLayout.PREFERRED_SIZE, 65, javax.swing.GroupLayout.PREFERRED_SIZE))
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addComponent(c4)))
                .addContainerGap())
        );
        layout.setVerticalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, layout.createSequentialGroup()
                ...
                .addGap(55, 55, 55)
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(seatok, javax.swing.GroupLayout.PREFERRED_SIZE, 33, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addComponent(jButton1))
                .addGap(55, 55, 55))
        );
    ...
    private void a1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_a1ActionPerformed
        ...
        try {
            int choose = JOptionPane.showConfirmDialog(null, "좌석을 예약하시겠습니까?", "예약 확인창", JOptionPane.YES_NO_OPTION);
            if (choose == JOptionPane.YES_OPTION) {
                user.DBWrite(seat1 + " " + e + " " + aprice);
                user.Split();
                JOptionPane.showMessageDialog(null, "좌석이 예약되었습니다.");
                a1.setEnabled(false);
            } else if (choose == JOptionPane.NO_OPTION) {
                JOptionPane.showMessageDialog(null, "좌석이 예약되지 않았습니다. 다시 선택해주세요.");
                a1.setEnabled(true);
            }
        } catch (IOException ex) {
            Logger.getLogger(Seat3.class.getName()).log(Level.SEVERE, null, ex);
