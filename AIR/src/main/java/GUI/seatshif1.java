 ...
 * @author Free
 */
public class seatshif1 extends javax.swing.JFrame {
    login lg=new login();
    String e=lg.a;
    ...
    public void data(String e){
        seatshiftdata data1 = new seatshiftdata();
        Command seatshiftdata1 = new seatshiftdata1(data1);
        
        commandexcut excut = new commandexcut(seatshiftdata1);
        excut.pressed();
