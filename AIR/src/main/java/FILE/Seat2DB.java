 ...
 * @author Free
 */
public class Seat2DB implements fileInterface {
    ...
    public void DBWrite(String a) throws IOException {
        BufferedWriter BFW = new BufferedWriter(new FileWriter("C:\\DB\\Seat2.txt", true));
    ...
    public void DB() {
        try {
            File text = new File("C:\\DB\\Seat2.txt");
