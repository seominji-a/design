 ...
 * @author hun24
 */
public class Book implements fileInterface {

    ArrayList<String> readInfo = new ArrayList<>();
    ArrayList<Seatinfo> Book = new ArrayList<>();

    @Override
    public void DBWrite(String a) throws IOException {
        BufferedWriter BFW = new BufferedWriter(new FileWriter("C:\\DB\\Book.txt", true));
    ...
    public void DB() {
        try {
            File text = new File("C:\\DB\\Book.txt");
